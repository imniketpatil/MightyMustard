...
export function ImportGlobe() {
  return (
    <div className="relative flex h-full w-full max-w-[32rem] items-center justify-center overflow-hidden rounded-lg   p-4 md:px-20 md:py-40 md:shadow-2xl">
      {/* Text Section */}
      <span className="pointer-events-none z-10 h-full w-full whitespace-pre-wrap bg-gradient-to-b from-black to-gray-600 bg-clip-text text-center text-4xl lg:text-5xl font-bold leading-tight text-transparent  animate-fadeIn">
        We Export To
      </span>
